...
@if ( ! $TheWayWeWorkData->isEmpty() )
@foreach ($TheWayWeWorkData as $value)
...
<section id="home-section" class="d-flex align-items-center property-sales" style="background:#fff url('{{ asset('uploads') . '/'.  $value->mainimage->main_image }}') no-repeat; background-size: 100% auto;">
