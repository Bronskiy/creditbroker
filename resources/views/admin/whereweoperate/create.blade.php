...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('top_text', old('top_text'), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('map_text_3', old('map_text_3'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('map_text_4', old('map_text_4'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('map_text_5', old('map_text_5'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('map_text_6', old('map_text_6'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('map_text_7', old('map_text_7'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('map_text_8', old('map_text_8'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('map_text_9', old('map_text_9'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('map_text_10', old('map_text_10'), array('class'=>'form-control ckeditor')) !!}
