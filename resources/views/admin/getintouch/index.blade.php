...
<td>{{ isset($row->seo->meta_title) ? $row->seo->meta_title : '' }}</td>
                            ...
                            <td>
                                ...
                                {!! Form::open(array('style' => 'display: inline-block;', 'method' => 'DELETE', 'onsubmit' => "return confirm('".trans("quickadmin::templates.templates-view_index-are_you_sure")."');",  'route' => array(config('quickadmin.route').'.getintouch.destroy', $row->id))) !!}
            ...
            {!! Form::open(['route' => config('quickadmin.route').'.getintouch.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
