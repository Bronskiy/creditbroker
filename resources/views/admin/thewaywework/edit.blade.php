...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('main_text', old('main_text',$thewaywework->main_text), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('bottom_section', 'Bottom Section', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::textarea('bottom_section', old('bottom_section',$thewaywework->bottom_section), array('class'=>'form-control ckeditor')) !!}
