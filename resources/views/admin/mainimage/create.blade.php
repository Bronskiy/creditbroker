...
{!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.mainimage.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('link_title', old('link_title'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('link_url', 'Link URL', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('link_url', old('link_url'), array('class'=>'form-control')) !!}
