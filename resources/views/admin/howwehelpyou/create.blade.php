...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('1_item_text', old('1_item_text'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('2_item_text', old('2_item_text'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('3_item_text', old('3_item_text'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('4_item_text', old('4_item_text'), array('class'=>'form-control ckeditor')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::textarea('5_item_text', old('5_item_text'), array('class'=>'form-control ckeditor')) !!}
